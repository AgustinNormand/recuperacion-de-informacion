class Exporter:
	def __init__(self, term_frequencies, token_list, term_length_acumulator, token_stem, collection):
	...
	def generate_token_stem_file(self):
		with open(self.token_stem_file_path, "w") as f:
			for token_stem in self.token_stem:
				f.write("{}->{}\r\n".format(token_stem, self.token_stem[token_stem]))
				#print(token_stem)
				#print(self.token_stem[token_stem])
				#f.write(token_stem)
		print("Archivo {} exportado.".format(self.token_stem_file_path))
