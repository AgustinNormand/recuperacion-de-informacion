...
def merge_index(final_index, thread_index):
    for key in thread_index:
        final_index[key] = thread_index[key]
...
def process_results(results):
    ...
    for result in results:
        ...
        merge_index(final_index, result[2])
    sort_inverted_index(final_inverted_index)
    return [final_vocabulary, final_inverted_index, final_index]
