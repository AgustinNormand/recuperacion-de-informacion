...
r = Retrieval(metadata, False, False, True)
skip_retrieval = Retrieval(metadata, False, True)
...
for value in statistics:
    ...
    for query in statistics[value]["querys"]:
        ...
        mem_query_time = measure_query_time(query["query"], skip_retrieval)
        ...
        without_skips_acumulator += query_time
        skip_acumulator += mem_query_time
