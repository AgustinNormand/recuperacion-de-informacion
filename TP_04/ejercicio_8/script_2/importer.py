    ...
    def read_vocabulary(self):
        with open(INDEX_FILES_PATH + BIN_VOCABULARY_FILENAME, "rb") as f:
            ...
            while content != b'':
                ...
                vocabulary[term] = (df, pointer_index, pointer_skips, pointer_dgaps)
                content = f.read(read_size)

        return vocabulary

    def get_dgaps_part(self, pointer, amount):
        with open(INDEX_FILES_PATH + BIN_DGAPS_FILENAME, "rb") as f:
            f.seek(pointer)
